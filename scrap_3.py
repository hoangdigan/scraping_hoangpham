...
def main():
  driver = get_drvier()
  driver.find_element(by="id", value="CustomerEmail").send_keys("hoangdigan@gmail.com")
  time.sleep(2)
  driver.find_element(by="id", value="CustomerPassword").send_keys("Hoangpham@2023@" + Keys.RETURN)
  time.sleep(2)
